...
path = "/home/ucchip/th/gps_test_rec/2022/0430/"
#name = "4_disable_fixPR_HighPWR100_0928fw.log"
# name = "1_disable_fixPR_pwr122_qfn12_1009_1307.log"
# name = "7_enable_pwr122_qnf12_1010fw.log"
# name = "3_1017fw_pwr122_fixPR_disable_1017_1227.log"
# name = "navTst_fixPr_newFw_bit0.log"
name = "./navTst_fixPr_bds131_newFw_bit1New_3.log"
# path = "/home/ucchip/th/gps_test_rec/0811/"
# name = "fixPr_prPrec_1_0811fw2_gps.log"
...
def fix_pr_std(path_name):
    TGT_CHL = 8
    CHL_DEV = []
    print("\n", path_name)

    with open(path_name, 'r', errors="ignore") as fd:
        cnt = 0
        valid_sv_idx = []
        PR = []
        time = []
