    ...
    core.Message(0x43, 'SIG', [
        ...
        core.RepeatedBlock('RB', [
            ...
            core.BitField('sigFlags', 'X2', [
                core.Flag('health', 0, 1),
                core.Flag('prSmoothed', 1, 2),
                core.Flag('prUsed', 2, 3),
                core.Flag('crUsed', 3, 4),
                core.Flag('doUsed', 4, 5),
                core.Flag('prCorrUsed', 5, 6),
                core.Flag('crCorrUsed', 6, 7),
                core.Flag('doCorrUsed', 7, 8),
            ]),
            core.PadByte(repeat=3),
        ])
    ]),
